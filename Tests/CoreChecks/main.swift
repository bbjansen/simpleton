...
await runSQLSavedQueryStoreChecks(runner)
...
runSQLWorkspaceLayoutChecks(runner)
runConnectionChecks(runner)
runSQLClientCommandChecks(runner)
runSQLCellFormattingChecks(runner)
runSQLGridDataChecks(runner)
runSQLTokenizerChecks(runner)
runSQLResultExporterChecks(runner)
runSQLRunStatsChecks(runner)
